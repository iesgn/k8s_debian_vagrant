...
IP_ADDRESS=$(echo "10.0.10.`expr 11 + ${instance}`")
...
scp Config/ca.pem Config/ca-key.pem Config/kubernetes-key.pem Config/kubernetes.pem Config/service-account-key.pem Config/service-account.pem root@${instance}:~/
done
```
